...
public class JPRallyTableSellProducts extends JPanel {

	private static final long serialVersionUID = 1L;

	private JPanel panel1;

	public JPRallyTableSellProducts(ActionListener listener, Object[][] data) {
		setVisible(true);
		setOpaque(false);
	...
	private void initComponents(ActionListener actionListener, Object[][] data) {
		...
		PanelTableSells image = new PanelTableSells();
		image.addData(data);
